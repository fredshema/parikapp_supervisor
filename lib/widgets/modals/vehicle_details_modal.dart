...
class VehicalDetailsModal extends StatefulWidget {
  final Map<String, dynamic> vehicle;

  const VehicalDetailsModal({Key? key, required this.vehicle})
      : super(key: key);

  @override
  State<VehicalDetailsModal> createState() => _VehicalDetailsModalState();
}

class _VehicalDetailsModalState extends State<VehicalDetailsModal> {
  @override
  void initState() {
    super.initState();
  }
